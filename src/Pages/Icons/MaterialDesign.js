...
const MaterialDesignIcons = props => {
  document.title = "Material Design Icon | Matary - React Admin & Dashboard Template";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
        <Breadcrumbs title="Icons" breadcrumbItem="Material Design" />
          ...
          <Row className="icons-demo-content">
            <Col xs="12">
              ...
              <Card>
                <CardHeader>
                <h4 className="card-title">All Icons</h4>
                  </CardHeader>
