...
import { Container, UncontrolledDropdown, DropdownMenu, DropdownItem, DropdownToggle, Col, Row, Card, CardBody, CardHeader } from "reactstrap";

//Import Breadcrumb
import Breadcrumbs from "../../components/Common/Breadcrumb";

const UiButtons = () => {
  document.title = "Buttons | Matary - React Admin & Dashboard Template";
        ...
        <Container fluid={true}>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">Make buttons look inactive by adding the <code>disabled</code> boolean attribute to any <code>&lt;button&gt;</code> element. Disabled buttons have <code>pointer-events: none</code> applied to, preventing hover and active states from triggering.</p>
                </CardHeader>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <h4 className="card-title">Link Functionality Caveat Disable Buttons</h4>
                  <p className="card-title-desc"><code>&lt;a&gt;</code>s don't support the <code>disabled</code> attribute, so you must add the <code>.disabled</code> class and <code>aria-disabled="true"</code> to make it visually appear disabled. also include a <code>tabindex="-1"</code> attribute.</p>
                </CardHeader>

                <CardBody>
                  <div className="d-flex flex-wrap gap-2">
                    <Link to="#" className="btn btn-primary btn-lg disabled" role="button" aria-disabled="true">Primary link</Link>
                    <Link to="#" className="btn btn-secondary btn-lg disabled" tabIndex="-1" role="button" aria-disabled="true">Link</Link>
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div className="d-flex flex-wrap gap-2">
                    ...
                    {/* <!-- Toggle States Link --> */}
                    <Link to="#" className="btn btn-primary" role="button" data-bs-toggle="button">Toggle link</Link>
                    <Link to="#" className="btn btn-primary active" role="button" data-bs-toggle="button" aria-pressed="true">Active toggle link</Link>
                    <Link to="#" className="btn btn-primary disabled" aria-disabled="true" role="button" data-bs-toggle="button">Disabled toggle link</Link>
                  </div>
                </CardBody>
              </Card>
            </Col>
                  ...
                  <div className="d-flex flex-wrap gap-4 align-items-start">
                    <div className="btn-group" role="group" aria-label="Button group with nested dropdown">
                      ...
                      <div className="btn-group" role="group">
                        ...
                        <UncontrolledDropdown id="btnGroupDrop1" type="button">
